...
int ModifiedEmployee(Employee* list, int len)
{
	...
	do
	{
		...
		{
			case 1:
				PedirCadena(cadena, "Ingrese el nombre a modificar: ", "Error, Reingrese el nombre: ");
				strcpy(list[posicion].name,cadena);
			break;
			case 2:
				PedirCadena(cadena, "Ingrese el apellido a modificar: ", "Error, Reingrese el apellido: ");
				strcpy(list[posicion].lastName,cadena);
			break;
			case 3:
